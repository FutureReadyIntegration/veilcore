...
class VeilHospitalGUIOrgans(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("Veil OS Organ Engine — Hospital GUI (Organs)")
    ...
    def _build_cmd(self):
        ...
        # If your CLI doesn't support these flags yet, tell me and I will generate a v3 GUI
        # that only passes args your CLI actually accepts.
        if self.enable_writes.get():
    ...
    def _on_select_organ(self, _evt=None):
        ...
        # display: "⚡ epic (P0)" -> name is everything between first space and last " ("
